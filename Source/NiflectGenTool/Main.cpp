	...
	if (true)//if (false)//
	{
		...
		auto memTest = GetDefaultMemoryStats();
		{
			...
			if (true)
			{
				...
				//	"-a", "../../../../../../Source/Niflect/include/Niflect/Default/DefaultAccessorSetting.h",
				...
				//	"-gam",
				//	"-a", "../../../../../../../Wishing/ThirdParty/Niflect/Niflect/include/Niflect/Default/DefaultAccessorSetting.h",
