...
if(WIN32)
	set(ProjectPlatformArchDirPath ${CMAKE_BINARY_DIR})
else()
	set(ProjectPlatformArchDirPath "${CMAKE_BINARY_DIR}/..")
endif()
set(ProjectBinDirPathDebug ${ProjectPlatformArchDirPath}/Debug/${BinDirName})
set(ProjectBinDirPathRelease ${ProjectPlatformArchDirPath}/Release/${BinDirName})
set(ProjectLibDirPathDebug ${ProjectPlatformArchDirPath}/Debug/${LibDirName})
set(ProjectLibDirPathRelease ${ProjectPlatformArchDirPath}/Release/${LibDirName})
...
set(InstalledPlatformArchDirPath build/${ProjectPlatform}/${ProjectArch})
set(InstalledPlatformArchDirPathDebug ${InstalledPlatformArchDirPath}/${RelativeInstallTargetDirPathDebug})
set(InstalledPlatformArchDirPathRelease ${InstalledPlatformArchDirPath}/${RelativeInstallTargetDirPathRelease})
...
if(WIN32)
	...
	set(StorageDirPath /mnt/Ubuntu_Storage)
endif()
