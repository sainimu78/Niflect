...
if(WIN32)
	...
	get_filename_component(ProjectBinDirPathDebug "${CMAKE_BINARY_DIR}/../Debug/${BinDirName}" ABSOLUTE)
	get_filename_component(ProjectBinDirPathRelease "${CMAKE_BINARY_DIR}/../Release/${BinDirName}" ABSOLUTE)
	get_filename_component(ProjectLibDirPathDebug "${CMAKE_BINARY_DIR}/../Debug/${LibDirName}" ABSOLUTE)
	get_filename_component(ProjectLibDirPathRelease "${CMAKE_BINARY_DIR}/../Release/${LibDirName}" ABSOLUTE)
endif()
